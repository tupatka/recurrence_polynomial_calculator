...
/**
 * Pod l zmiennych wielomianu p, oznaczonych jako @f$x_0@f$, @f$x_1@f$, ..., @f$x_{l-1}@f$,
 * podstawia @p k kolejnych wielomianów z tablicy q,
 * oznaczonych jako @f$q_0@f$, @f$q_1@f$, ..., @f$q_{k-1}@f$,.
 * Jeśli @f$k < l@f$ pod zmienne @f$x_k@f$, ..., @f$x_{l-1}@f$ podstawiane są zera.
 * Zwraca wynik operacji składania wielomianów.
