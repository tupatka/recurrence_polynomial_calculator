...
void PrintfPoly(const Poly *p, poly_exp_t exp, int i) {
    printf ("(");
...
//    Poly A = P(C(1), 0, P(C(1), 1), 1);
//    PrintCaly(A);
//    Poly B = PolyExpBySquaring(&A, 0);
//    PrintCaly(B);
//    PolyDestroy(&B);
//
//    Poly G = PolyExpBySquaring(&A, 1);
//    PrintCaly(G);
//    PolyDestroy(&G);
//
//    Poly D = PolyExpBySquaring(&A, 2);
//    PrintCaly(D);
//    PolyDestroy(&D);
//
//    Poly E = PolyExpBySquaring(&A, 3);
//    PrintCaly(E);
//    PolyDestroy(&E);
//
//    Poly F = PolyExpBySquaring(&A, 4);
//    PrintCaly(F);
//    PolyDestroy(&F);
//
//    PolyDestroy(&A);
