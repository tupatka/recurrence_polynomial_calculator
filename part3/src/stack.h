 ...
 * @param[in] stack : stos
 * @return czy stos jest do połowy pusty
 */
...
/**
 * Sprawdza, czy na stosie znajduje się co najmniej n wielomianów.
 * @param[in] stack : stos
 * @param[in] n : oczekiwana liczba wielomianów na stosie
 * @return czy na stosie znajduje się co najmniej n wielomianów
 */
bool IsStackOfSizeAtLeastN(const Stack* stack, size_t n);
